...
Copier ce JSON dans e répertoire `.claude/settings.json`, puis placer les trois scripts (guard-bash.sh, protect-files.sh, session-context.sh) dans `.claude/hooks/` et les rendre exécutables avec `chmod +x .claude/hooks/*.sh`
