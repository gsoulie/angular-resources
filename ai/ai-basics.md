...
![image](https://github.com/gsoulie/angular-resources/blob/master/ai/images/iacomparison.png =250x)     
# RESSOURCES 
...
* Les LLMs utilisent des mécanismes d’attention qui privilégient naturellement les premières et dernières informations, au détriment du milieu.
...
1. Découpez le document en morceaux pertinents.
2. Utilisez un système de reranking pour placer les 3-5 passages les plus importants en tête.
3. Ajoutez un résumé contextuel avant chaque extrait pour guider le modèle
